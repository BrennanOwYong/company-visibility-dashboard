...
5. Update kanban status at each stage:
   ...
   - `kanban-update {{FEATURE_NAME}} BLOCKED_ON "exactly what is missing"`
6. Test your feature. Tests must pass before marking done.
...
9. Call `kanban-done {{FEATURE_NAME}} "plain-language summary"` when done.
